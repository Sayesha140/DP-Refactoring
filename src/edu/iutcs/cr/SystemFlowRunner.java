...
public class SystemFlowRunner {
    ...
    public SystemFlowRunner() {
        ...
        this.personHandler = new PersonHandler(database, reader);
        this.vehicleHandler = new VehicleHandler(database, reader);
        this.displayHandler = new DisplayHandler(database, reader);
        this.orderHandler = new OrderHandler(database, reader);
    }
